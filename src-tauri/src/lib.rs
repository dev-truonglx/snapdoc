...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::recording_paused_state,
            ...
            history::commands::delete_history_items,
            history::commands::restore_history_item,
            history::commands::restore_history_items,
            history::commands::permanently_delete_history_item,
            history::commands::permanently_delete_history_items,
